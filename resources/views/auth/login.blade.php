                ...
                <div class="row">
                    <div class="col-4">
                        <div class="text-center">
                            <img src="{{ URL::asset('assets/img/pics_logo.png') }}" alt="images" class="img-fluid mb-3">
                            <h4 class="f-w-500 mb-1">Login with
                                your email</h4>
                        ...
                        <form method="POST" action="{{ route('login.auth.test') }}">
                            ...
                            <div class="form-group mb-3">
                                <input type="email" class="form-control @error('email') is-invalid @enderror"
                                    name="email" value="admin@phoenixcoded.com" required autocomplete="email" autofocus
                            ...
                            <div class="form-group mb-3">
                                <input type="password" type="password"
                                    ...
                                    name="password" required autocomplete="current-password" id="floatingInput1"
